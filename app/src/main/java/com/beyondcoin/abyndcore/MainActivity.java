...
public class MainActivity extends AppCompatActivity {
    ...
    private void postStart() {
        ...
        mTvStatus.setText(getString(R.string.runningturnoff, useDistribution, /*"knots".equals(useDistribution) ? Packages.BEYONDCOIN_KNOTS_NDK : "liquid".equals(useDistribution) ? Packages.BEYONDCOIN_LIQUID_NDK :*/ Packages.BEYONDCOIN_NDK));
    ...
    private void postConfigure() {
        final SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(this);
        final String useDistribution = prefs.getString("usedistribution", "core");
        mTvStatus.setText(getString(R.string.stoppedturnon, useDistribution, /*"knots".equals(useDistribution) ? Packages.BEYONDCOIN_KNOTS_NDK : "liquid".equals(useDistribution) ? Packages.BEYONDCOIN_LIQUID_NDK :*/ Packages.BEYONDCOIN_NDK));
